    ...
    for iter in iterations
        if convergence == 0
            ...
            @timeit TO "Update prices" begin
                if data["scenario"]["ref_scen_number"] == data["scenario"]["scen_number"] # calibration run, 2021 to be calibrated
                ...
                push!(results[ "λ"]["H2"], [maximum([0,results[ "λ"]["H2"][end][jy] - ADMM["ρ"]["H2"][end]/100*ADMM["Imbalances"]["H2"][end][jy]]) for jy in mdict[agents[:all][end]].ext[:sets][:JY]])
            ...
            @timeit TO "Progress bar" begin
                if data["scenario"]["Additionality"] == "Monthly"
                    set_description(iterations, string(@sprintf("ΔETS: %.3f -- ΔMSR: %.3f -- ΔEOM %.3f -- ΔREC-y %.3f --  ΔREC-m %.3f -- ΔH2 %.3f -- ΔH2CN-PROD %.3f -- ΔH2CN-CAP %.3f ",  ADMM["Residuals"]["Primal"]["ETS"][end]/ADMM["Tolerance"]["ETS"],ADMM["Residuals"]["Primal"]["MSR"][end]/ADMM["Tolerance"]["ETS"], ADMM["Residuals"]["Primal"]["EOM"][end]/ADMM["Tolerance"]["EOM"],ADMM["Residuals"]["Primal"]["REC_y"][end]/ADMM["Tolerance"]["REC_y"],ADMM["Residuals"]["Primal"]["REC_m"][end]/ADMM["Tolerance"]["REC_m"],ADMM["Residuals"]["Primal"]["H2"][end]/ADMM["Tolerance"]["H2"],ADMM["Residuals"]["Primal"]["H2CN_prod"][end]/ADMM["Tolerance"]["H2CN_prod"],ADMM["Residuals"]["Primal"]["H2CN_cap"][end]/ADMM["Tolerance"]["H2CN_cap"])))
                elseif data["scenario"]["Additionality"] == "Daily"
                    set_description(iterations, string(@sprintf("ΔETS: %.3f -- ΔMSR: %.3f -- ΔEOM %.3f -- ΔREC-y %.3f --  ΔREC-d %.3f -- ΔH2 %.3f -- ΔH2CN-PROD %.3f -- ΔH2CN-CAP %.3f ",  ADMM["Residuals"]["Primal"]["ETS"][end]/ADMM["Tolerance"]["ETS"],ADMM["Residuals"]["Primal"]["MSR"][end]/ADMM["Tolerance"]["ETS"], ADMM["Residuals"]["Primal"]["EOM"][end]/ADMM["Tolerance"]["EOM"],ADMM["Residuals"]["Primal"]["REC_y"][end]/ADMM["Tolerance"]["REC_y"],ADMM["Residuals"]["Primal"]["REC_d"][end]/ADMM["Tolerance"]["REC_d"],ADMM["Residuals"]["Primal"]["H2"][end]/ADMM["Tolerance"]["H2"],ADMM["Residuals"]["Primal"]["H2CN_prod"][end]/ADMM["Tolerance"]["H2CN_prod"],ADMM["Residuals"]["Primal"]["H2CN_cap"][end]/ADMM["Tolerance"]["H2CN_cap"])))
                elseif data["scenario"]["Additionality"] == "Hourly"
                    set_description(iterations, string(@sprintf("ΔETS: %.3f -- ΔMSR: %.3f -- ΔEOM %.3f -- ΔREC-y %.3f --  ΔREC-h %.3f -- ΔH2 %.3f -- ΔH2CN-PROD %.3f -- ΔH2CN-CAP %.3f ",  ADMM["Residuals"]["Primal"]["ETS"][end]/ADMM["Tolerance"]["ETS"],ADMM["Residuals"]["Primal"]["MSR"][end]/ADMM["Tolerance"]["ETS"], ADMM["Residuals"]["Primal"]["EOM"][end]/ADMM["Tolerance"]["EOM"],ADMM["Residuals"]["Primal"]["REC_y"][end]/ADMM["Tolerance"]["REC_y"],ADMM["Residuals"]["Primal"]["REC_h"][end]/ADMM["Tolerance"]["REC_h"],ADMM["Residuals"]["Primal"]["H2"][end]/ADMM["Tolerance"]["H2"],ADMM["Residuals"]["Primal"]["H2CN_prod"][end]/ADMM["Tolerance"]["H2CN_prod"],ADMM["Residuals"]["Primal"]["H2CN_cap"][end]/ADMM["Tolerance"]["H2CN_cap"])))
                else
                    set_description(iterations, string(@sprintf("ΔETS: %.3f -- ΔMSR: %.3f -- ΔEOM %.3f -- ΔREC-y %.3f -- ΔH2 %.3f -- ΔH2CN-PROD %.3f -- ΔH2CN-CAP %.3f ",  ADMM["Residuals"]["Primal"]["ETS"][end]/ADMM["Tolerance"]["ETS"],ADMM["Residuals"]["Primal"]["MSR"][end]/ADMM["Tolerance"]["ETS"], ADMM["Residuals"]["Primal"]["EOM"][end]/ADMM["Tolerance"]["EOM"],ADMM["Residuals"]["Primal"]["REC_y"][end]/ADMM["Tolerance"]["REC_y"],ADMM["Residuals"]["Primal"]["H2"][end]/ADMM["Tolerance"]["H2"],ADMM["Residuals"]["Primal"]["H2CN_prod"][end]/ADMM["Tolerance"]["H2CN_prod"],ADMM["Residuals"]["Primal"]["H2CN_cap"][end]/ADMM["Tolerance"]["H2CN_cap"])))
                end
            end

            # Check convergence: primal and dual satisfy tolerance 
            if ADMM["Residuals"]["Primal"]["MSR"][end] <= ADMM["Tolerance"]["ETS"] && ADMM["Residuals"]["Primal"]["ETS"][end] <= ADMM["Tolerance"]["ETS"] && ADMM["Residuals"]["Dual"]["ETS"][end] <= ADMM["Tolerance"]["ETS"] && ADMM["Residuals"]["Primal"]["EOM"][end] <= ADMM["Tolerance"]["EOM"] && ADMM["Residuals"]["Dual"]["EOM"][end] <= ADMM["Tolerance"]["EOM"] && ADMM["Residuals"]["Primal"]["REC_y"][end] <= ADMM["Tolerance"]["REC_y"] && ADMM["Residuals"]["Primal"]["REC_m"][end] <= ADMM["Tolerance"]["REC_m"] && ADMM["Residuals"]["Primal"]["REC_d"][end] <= ADMM["Tolerance"]["REC_d"] && ADMM["Residuals"]["Primal"]["REC_h"][end] <= ADMM["Tolerance"]["REC°h"] && ADMM["Residuals"]["Dual"]["REC_y"][end] <= ADMM["Tolerance"]["REC_y"] && ADMM["Residuals"]["Dual"]["REC_m"][end] <= ADMM["Tolerance"]["REC_m"] && ADMM["Residuals"]["Dual"]["REC_d"][end] <= ADMM["Tolerance"]["REC_d"] && ADMM["Residuals"]["Dual"]["REC_h"][end] <= ADMM["Tolerance"]["REC_h"] && ADMM["Residuals"]["Primal"]["H2"][end] <= ADMM["Tolerance"]["H2"] && ADMM["Residuals"]["Dual"]["H2"][end] <= ADMM["Tolerance"]["H2"] && ADMM["Residuals"]["Primal"]["H2CN_prod"][end] <= ADMM["Tolerance"]["H2CN_prod"] && ADMM["Residuals"]["Dual"]["H2CN_prod"][end] <= ADMM["Tolerance"]["H2CN_prod"] && ADMM["Residuals"]["Primal"]["H2CN_cap"][end] <= ADMM["Tolerance"]["H2CN_cap"] && ADMM["Residuals"]["Dual"]["H2CN_cap"][end] <= ADMM["Tolerance"]["H2CN_cap"]
                convergence = 1
            end
