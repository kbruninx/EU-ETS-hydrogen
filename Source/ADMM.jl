    ...
    for iter in iterations
        if convergence == 0
            ...
            @timeit TO "Update prices" begin
                ...
                push!(results[ "λ"]["EOM"], results[ "λ"]["EOM"][end] - ADMM["ρ"]["EOM"][end]*10*ADMM["Imbalances"]["EOM"][end])
                push!(results[ "λ"]["REC_y"], results[ "λ"]["REC_y"][end] - ADMM["ρ"]["REC_y"][end]/(10*data["General"]["nReprDays"])*ADMM["Imbalances"]["REC_y"][end])
                push!(results[ "λ"]["REC_m"], results[ "λ"]["REC_m"][end] - ADMM["ρ"]["REC_m"][end]/(10*12)*ADMM["Imbalances"]["REC_m"][end])
                push!(results[ "λ"]["REC_d"], results[ "λ"]["REC_d"][end] - ADMM["ρ"]["REC_d"][end]/(data["General"]["nReprDays"])*ADMM["Imbalances"]["REC_d"][end])
                push!(results[ "λ"]["REC_h"], results[ "λ"]["REC_h"][end] - ADMM["ρ"]["REC_h"][end]*ADMM["Imbalances"]["REC_h"][end])
                push!(results[ "λ"]["H2"], [maximum([0,results[ "λ"]["H2"][end][jy] - ADMM["ρ"]["H2"][end]/(100*data["General"]["nReprDays"])*ADMM["Imbalances"]["H2"][end][jy]]) for jy in mdict[agents[:all][end]].ext[:sets][:JY]])
                push!(results[ "λ"]["H2CN_prod"], results[ "λ"]["H2CN_prod"][end] - ADMM["ρ"]["H2CN_prod"][end]/(100*data["General"]["nReprDays"])*ADMM["Imbalances"]["H2CN_prod"][end])
